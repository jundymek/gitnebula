...
| The sample run's numbers (295 nodes, 360 edges, 60 co-change pairs, 0.25 s) and its summary line. | Replaced by a real run over a fresh clone of the merged epic: 406 nodes, 492 edges, 181 co-change pairs, and the summary line now names the analysis window. | **5.5** (AC-5), plus history since 4.3 |
