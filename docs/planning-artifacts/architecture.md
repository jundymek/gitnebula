<!-- Stable projection of the architecture spine for implementing agents.
     Source of truth: docs/planning-artifacts/architecture/architecture-gitnebula-2026-08-10/
     (ARCHITECTURE-SPINE.md + .memlog.md decision trail). Regenerate this file
     from the spine on any update; do not edit it independently. -->
